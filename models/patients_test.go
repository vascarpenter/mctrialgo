...
var (
	patientDBTypes = map[string]string{`ID`: `int`, `PatientID`: `varchar`, `HospitalID`: `int`, `Serialid`: `int`, `Trialgroup`: `int`, `Initial`: `varchar`, `Birthdate`: `date`, `Female`: `tinyint`, `Age`: `int`, `Allowdate`: `date`, `Startdate`: `date`, `Dropdate`: `date`, `Dropout`: `tinyint`, `Finishdate`: `date`, `Diffdays`: `int`}
	_              = bytes.MinRead
)
