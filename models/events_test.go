...
var (
	eventDBTypes = map[string]string{`ID`: `int`, `HospitalID`: `int`, `Serialid`: `int`, `Eventid`: `int`, `Date`: `date`, `Alive`: `tinyint`, `Dropout`: `tinyint`, `Macce`: `tinyint`, `BH`: `int`, `BW`: `int`, `SBP`: `int`, `DBP`: `int`, `HR`: `int`, `Event`: `varchar`, `Diffdays`: `int`}
	_            = bytes.MinRead
)
...
func testEventsUpsert(t *testing.T) {
	...
	if len(mySQLEventUniqueColumns) == 0 {
